#' Generate data from the Clayton copula for serial dependence and the Frank copula for dependent censoring with the Weibull distribuions
#'
...
#'
#' @usage ClaytonFrank.Weibull.data(r, nu_1, theta, lambda, nu_2, alpha, N, b, l)
#'
...
ClaytonFrank.Weibull.data = function(r, nu_1, theta, lambda, nu_2, alpha, N, b, l){
