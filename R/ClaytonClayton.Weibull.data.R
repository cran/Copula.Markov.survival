...
#'
#' @usage ClaytonClayton.Weibull.data(N, scale1, shape1, theta, scale2, shape2, alpha,  b, l)
#'
#' @param N sample size
...
ClaytonClayton.Weibull.data = function(N, scale1, shape1, theta, scale2, shape2, alpha, b, l){
