...
#'
#' @usage FrankClayton.Weibull.data(N, scale1, shape1, theta, scale2, shape2, alpha, b, l)
#'
...
FrankClayton.Weibull.data = function(N, scale1, shape1, theta, scale2, shape2, alpha, b, l){
